      ...
      <div id="reference" class="page-content">
        <div id="main-content">
          <div id="container" data-type="page">
            ...
            <div class="os-figure" id="Figure_01_03_001"><figure data-id="Figure_01_03_001" class="small">
            ...
            </figure><div class="os-caption-container"><span class="os-title-label">Figure </span><span class="os-number">1</span><span class="os-divider"> </span><span class="os-divider"> </span></div></div>
          </div>
        </div>
      </div>
      `;
          ...
          <div id="container" data-type="page">
            ...
            <div class="os-figure" id="Figure_01_03_001">
              ...
              <div class="os-caption-container">
                ...
                <span class="os-divider"> </span></div></div>
            </div>
        </div>
      </div>
      `;
